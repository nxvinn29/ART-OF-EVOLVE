...
// in art_of_evolve/test/features/goals/data/goal_repository_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i5;

import 'package:art_of_evolve/src/features/goals/domain/goal.dart' as _i3;
...
class MockBox extends _i1.Mock implements _i2.Box<_i3.Goal> {
  @override
  Iterable<_i3.Goal> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i3.Goal>[],
        returnValueForMissingStub: <_i3.Goal>[],
      ) as Iterable<_i3.Goal>);
  ...
  @override
  Iterable<_i3.Goal> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Goal? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, _i3.Goal> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i3.Goal>{},
        returnValueForMissingStub: <dynamic, _i3.Goal>{},
      ) as Map<dynamic, _i3.Goal>);
  ...
  @override
  _i5.Future<void> putAll(Map<dynamic, _i3.Goal>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i5.Future<int> add(_i3.Goal? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i5.Future<Iterable<int>> addAll(Iterable<_i3.Goal>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
